...
namespace Tests\PHPUnit\Modules\News\Admin;

use Modules\News\Admin\Installer;
use Modules\News\Admin\Uninstall;
...
class AdminTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testModuleIntegration() 
    {
        ...
        $moduleManager->deactivate('News');
        self::assertFalse($moduleManager->isActive('News'));

        $moduleManager->activate('News');
